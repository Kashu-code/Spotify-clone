...
function Player() {
  ...
  return (
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4 '>
      <div className="hidden bg-black lg:flex items-center gap-4">
        <img src={track.image} alt="" className='w-12 rounded' />
        <div>
          <p>{track.name}</p>
      ...
      <div className="flex flex-col items-center gap-1 m-auto">
        ...
        <div className="flex items-center gap-5">
          ...
          <div ref={seekbg} onClick={seekSong} className='w-80 max-w-[500px] bg-gray-300 rounded-full cursor-pointer'>
      ...
      <div className='hidden lg:flex items-center gap-2 opacity-75'>
        ...
        <div className='w-20 bg-slate-100 rounded h-1'></div>
